...
export default function MenuScreen() {
    ...
    const QuickAccessItem = ({ icon, label, route, color, isExternal = false }: any) => (
        <TouchableOpacity
            ...
            className="items-center justify-center w-[22%] md:w-[23%] aspect-square bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 mb-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
        >
    ...
    const ListItem = ({ icon, label, route, color, isExternal = false, subLabel }: any) => (
        <TouchableOpacity
            onPress={() => isExternal ? openLink(route) : router.push(route)}
            className="bg-white dark:bg-gray-900 p-4 rounded-2xl mb-3 flex-row items-center shadow-sm border border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
    ...
    return (
        <View className="flex-1 bg-gray-50 dark:bg-black" style={{ paddingTop: insets.top }}>
            <ScrollView className="flex-1 bg-gray-50 dark:bg-black" contentContainerStyle={{ flexGrow: 1 }}>
                <View className="bg-gray-50 dark:bg-black flex-1 pb-10">
                    ...
                    <View className="px-4 w-full max-w-4xl self-center">
                        {/* Living & Procedures */}
                        ...
                        <View className="md:grid md:grid-cols-2 md:gap-4">
                            <ListItem
                                ...
                                label={t('home.guide')}
                                subLabel={t('menu.living_procedures')}
                                route="/guide"
                        ...
                        <View className="flex-row gap-3 mb-8">
                            <TouchableOpacity
                                ...
                                className="flex-1 bg-white dark:bg-gray-900 p-4 rounded-2xl items-center border border-gray-100 dark:border-gray-800 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                            >
